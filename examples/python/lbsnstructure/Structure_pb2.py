...
# source: lbsnstructure/Structure.proto
...
_LBSNUSERGROUPS = _descriptor.Descriptor(
  name='lbsnUserGroups',
  full_name='lbsnUserGroups',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='pkey', full_name='lbsnUserGroups.pkey', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='usergroup_name', full_name='lbsnUserGroups.usergroup_name', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='usergroup_description', full_name='lbsnUserGroups.usergroup_description', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='member_count', full_name='lbsnUserGroups.member_count', index=3,
      number=4, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='usergroup_createdate', full_name='lbsnUserGroups.usergroup_createdate', index=4,
      number=5, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LBSNUSERGROUPS.fields_by_name['pkey'].message_type = _COMPOSITEKEY
_LBSNUSERGROUPS.fields_by_name['usergroup_createdate'].message_type = lbsnstructure_dot_external_dot_timestamp__pb2._TIMESTAMP
...
DESCRIPTOR.message_types_by_name['lbsnUserGroups'] = _LBSNUSERGROUPS
...
lbsnOrigin = _reflection.GeneratedProtocolMessageType('lbsnOrigin', (_message.Message,), dict(
  ...
  __module__ = 'lbsnstructure.Structure_pb2'
...
lbsnUserGroups = _reflection.GeneratedProtocolMessageType('lbsnUserGroups', (_message.Message,), dict(
  DESCRIPTOR = _LBSNUSERGROUPS,
  __module__ = 'lbsnstructure.Structure_pb2'
  # @@protoc_insertion_point(class_scope:lbsnUserGroups)
  ))
_sym_db.RegisterMessage(lbsnUserGroups)
