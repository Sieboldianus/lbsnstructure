...
# source: lbsnstructure/external/timestamp.proto
...
Timestamp = _reflection.GeneratedProtocolMessageType('Timestamp', (_message.Message,), dict(
  ...
  __module__ = 'lbsnstructure.external.timestamp_pb2'
