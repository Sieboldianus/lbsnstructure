...
If successful, you will see a file generated in output directory in your language, e.g. `Structure_pb2.py` ([Note](https://developers.google.com/protocol-buffers/docs/reference/python-generated) that currently both proto2 and proto3 append "_pb2.py" to generated filenames). 
This file can be imported to your tool (for python, `from . import Structure_pb2` . It looks similar to this:
